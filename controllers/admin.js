...
exports.getProductForm = (req, res, next) => {
    res.render('add-product', { name: 'Berkay', path: '/admin/add-product', pageTitle: 'Add Product' });
}
...
exports.editProductPage = (req, res, next) => {
    ...
    res.render('edit-product', { product: products[0], path: '/', pageTitle: 'Edit Product', name: 'Berkay' });
}
